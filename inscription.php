...
<section class="section auth-section">
    <div class="container">
        <div class="auth-wrapper">
            ...
            <form action="includes/account/inscription_process.php" method="post" enctype="multipart/form-data" class="auth-form" novalidate>

                <div class="row g-3">
                    <div class="col-12 col-sm-6">
                        <label for="firstname" class="form-label">Prénom</label>
                        <input type="text" class="form-control auth-input" id="firstname" name="firstname"
                               value="<?php echo htmlspecialchars($old['firstname'] ?? ''); ?>" required maxlength="100">
                    </div>

                    <div class="col-12 col-sm-6">
                        <label for="lastname" class="form-label">Nom</label>
                        <input type="text" class="form-control auth-input" id="lastname" name="lastname"
                               value="<?php echo htmlspecialchars($old['lastname'] ?? ''); ?>" required maxlength="150">
                    </div>
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <input type="password" class="form-control auth-input" id="password" name="password" required minlength="8">
                    </div>

                    <div class="col-12 col-sm-6">
                        <label for="password_confirm" class="form-label">Confirmer</label>
                        <input type="password" class="form-control auth-input" id="password_confirm" name="password_confirm" required minlength="8">
                    </div>

                    <div class="col-12">
                        <label for="pdp" class="form-label">Photo de profil <span class="auth-optional">(facultatif)</span></label>
                        <input type="file" class="form-control auth-input" id="pdp" name="pdp" accept="image/png, image/jpeg, image/webp">
