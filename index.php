        ...
        <div class="row">
            <div class="col-12 col-lg-8">
                ...
                <div class="d-flex flex-column flex-sm-row gap-3 mt-4">
                    <a href="<?= $heroInscriptionLink ?>"
                       class="btn btn-wtc-gold rounded-pill" target="_blank" rel="noopener">
...
<section class="section" id="horaires">
    <div class="container">
        ...
        <div class="season-card">
            ...
            <p class="season-card__sub">Ados à partir de 15 ans &amp; adultes tous niveaux — débutants à confirmés.</p>
            ...
            <p class="season-note">
                Retrouve le détail des contenus sur l'onglet <a href="seances.php">Séances</a> pour visualiser les séances de la semaine.
            </p>
        </div>
    </div>
</section>
        ...
        <div class="row g-3 g-md-4">
            <div class="col-12 col-lg-5">
                <div class="address-card">
                    ...
                    <a class="btn btn-wtc-outline rounded-pill align-self-start"
                       href="<?= $cardMapLink ?>" target="_blank" rel="noopener">
            ...
            <div class="col-12 col-lg-7">
                <div class="map-frame">
                    <iframe
                        src="https://www.google.com/maps?q=48.6113915,2.8807517&z=16&output=embed"
                        allowfullscreen
                        loading="lazy"
